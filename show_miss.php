...
#customers th {
  ...
  color: white;
    ...
    <h2 align="center"><font face="Geneva, Arial, Helvetica, sans-serif">MONTH WISE MISS CALL ALERT</h2>
...
$('#barChart').click(function(evt){
	var activePoints = myBarChart.getElementsAtEventForMode(evt, 'point', myBarChart.options);
        ...
        window.open('total_miss_bar.php?value='+label,'newwindow','width=800,height=600');
