...
DATENAME(mm, ReceiveDate) MONTH_NAME,
...
<table border=1 width="30%" id="customers">
		...
		<tr><TD><h2 align="center">MISS CALL ALERT</h2></td><td><img src="ebl_logo.jpg" width="131" height="116" /></td></tr>
...
<form method = "post" action="report_status_download_miss_call.php"  >
