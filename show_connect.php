...
#customers th {
  ...
  color: white;
    ...
    <h2 align="center"><font face="Geneva, Arial, Helvetica, sans-serif" size="+1">EBL CONNECT MONTHLY TRANSACTIONS</h2>
...
$('#barChart').click(function(evt){
	var activePoints = myBarChart.getElementsAtEventForMode(evt, 'point', myBarChart.options);
        ...
        window.open('total_connect_bar.php?value='+label,'newwindow','width=800,height=600');
