...
<head>
<!--
<form method = "post" action = "download_decline_bill.php">
	<table align="center">
 <TR>
                   <td align="center">
...
<div class="wrapper col3">
  <div id="container">
	...
	$query = mysqli_query($connect,"select a.skyId Sky_banking_ID,a.warning Decline_reason,a.creationDtTm  Transaction_date
 from apps_bill_pay a 
where DATE(a.creationDtTm )='$currentDateTime'
and a.isSuccess='N'
