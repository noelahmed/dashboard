...
<head>
<!--
<form method = "post" action = "download_decline_bill_connect.php">
	<table align="center">
 <TR>
                   <td align="center">
...
<div class="wrapper col3">
  <div id="container">
	...
	SELECT a.ref_no Sky_banking_ID,a.FAILED_REASON Decline_reason,a.T_TIME Transaction_date FROM eblconnect_lot_info_detail a
 where processed_status='Y' and processed_success='N'
