...
$query = "select reference_number,error_response,dates
...
while (oci_fetch($stid)) {?>
   <tr>
			...
			<td>
			 <?php echo oci_result($stid, 'REFERENCE_NUMBER') . "<br>\n";?>

</td>

<td>
 <?php echo oci_result($stid, 'ERROR_RESPONSE') . "<br>\n";?>
 
</td>

<td>
<?php echo oci_result($stid, 'DATES') . "<br>\n";?>
